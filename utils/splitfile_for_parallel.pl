...
\n";
my $usage = "\nUsage [$version]: 
    perl $scriptname -f <file that needs to be split> -s <sort the file or not, give yes or no> -l <line number> or -b <bytes>  or -n <number of individuals> [-o name of outputfile with the list of files][-p name of the splitfiles] [-v] [-c] [-h] 
